...
public class Conta implements Serializable {
	...
	public void sacar (double valorSaque){
		...
		if (saldoConta < valorSaque) {
			System.out.println("Não foi possível completar a operação, pois o valor do saque é maior do que o saldo da conta");
		}else {
			saldoConta = saldoConta - valorSaque;
			System.out.println("seu saldo agora é: " + saldoConta);
		}
